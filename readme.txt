...
The scripts that are name youtube-dl* are probably obsolete and should be transitioned to being yt-dlp based (you know what they say: yt-dlp based, youtube-dl cringe) in the future, for greater compatibility with the current youtube website, etc. However, youtube-dl still seems to work with twitch, and adapting those scripts to yt-dlp was not painless, and so youtube-dl is still a crucial component of those scripts for the time being.
