...
REM also do powershell q and ^W and ^D
...
powershell "echo 'Function  { Invoke-Command -ScriptBlock { Exit } }' >> $profile"
powershell "echo 'Function  { Invoke-Command -ScriptBlock { Exit } }' >> $profile"
powershell "echo 'Function q { Invoke-Command -ScriptBlock { Exit } }' >> $profile"
